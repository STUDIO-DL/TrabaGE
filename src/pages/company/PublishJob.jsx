...
function validateStructuredFields(form, status) {
  ...
  if (!form.city || !form.job_type || !form.work_mode) {
    return 'Completa ciudad, tipo de empleo y modalidad de trabajo.';
  }
      ...
      <form id="publish-job-form" onSubmit={handleSubmit} className="space-y-md p-md pb-lg">
        ...
        <Card padding="md" className="space-y-4">
          ...
          <Textarea
            ...
            hint="Obligatorio para publicar. Resume qué implica el puesto y qué busca la empresa."
          />
        </Card>
        ...
        <Card padding="md" className="space-y-4">
          ...
          <Textarea
            ...
            hint="Obligatorio para publicar. Escribe un requisito por línea."
          />
        </Card>
