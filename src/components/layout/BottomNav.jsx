...
export default function BottomNav() {
  ...
  const nav = (
    <nav
      ...
      data-bottom-nav=""
      className={[
        'fixed inset-x-0 bottom-0 z-nav border-t border-app-border bg-app-card/95 backdrop-blur supports-[backdrop-filter]:bg-app-card/92 keyboard-aware-footer lg:hidden',
