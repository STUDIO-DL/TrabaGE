...
export function getOrgLabels(profile, orgKind = null) {
  ...
  return {
    ...
    entityCapitalized: isOrganization ? 'Organización' : 'Business',
    profile: isOrganization ? 'Perfil de organización' : 'Perfil Business',
    verified: isOrganization ? 'Organización verificada' : 'Business verificado',
    ...
    followPrompt: isOrganization
      ...
      : 'Inicia sesión para seguir Business',
  };
}
