...
/** Discover hub sections — each maps to a Tema (topic slug) on publications, unless kind is people. */
export const DISCOVER_SECTIONS = [
  {
    id: 'people',
    title: 'Descubrir personas',
    description: 'Descubre profesionales relevantes para ampliar tu red profesional.',
    ctaLabel: 'Ver personas',
    pathSuffix: '/discover/people',
    kind: 'people',
    featured: true,
